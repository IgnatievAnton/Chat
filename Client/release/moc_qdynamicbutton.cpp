...
const QMetaObject QDynamicButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_QDynamicButton.data,
      qt_meta_data_QDynamicButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QDynamicButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QDynamicButton.stringdata0))
        return static_cast<void*>(const_cast< QDynamicButton*>(this));
